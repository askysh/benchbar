...
export MOCK_BREW_INSTALLED="python@3.11 node@20 mariadb@10.11 redis"
...
printf '# test zshrc\nexport EDITOR=vim\n' >"$HOME/.zshrc"
printf '#!/bin/bash\necho "Python 3.11.9"\n' >"$MOCK_BREW_PREFIX/opt/python@3.11/bin/python3.11"
chmod +x "$MOCK_BREW_PREFIX/opt/python@3.11/bin/python3.11"
