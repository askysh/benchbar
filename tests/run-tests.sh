...
ALL_TESTS="test-phases test-multi-bench test-doctor test-install-sh test-sites test-ports test-doctor-hardening
test-process test-adopt test-repair test-service test-cli test-migrate test-json test-report test-runner
test-profile-v16 test-run test-bench-flow test-version-policy test-templates test-shellrc test-ui test-platform"
