...
for t in test-ui test-templates test-shellrc test-platform test-run test-version-policy test-bench-flow test-runner test-process test-service test-migrate test-json test-doctor test-repair test-cli test-phases test-report test-adopt test-install-sh test-profile-v16; do
